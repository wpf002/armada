...
export function Anchor({
  ...
  return (
    <svg
      width={size}
      height={size}
      viewBox={`${ANCHOR_VIEWBOX.x} ${ANCHOR_VIEWBOX.y} ${ANCHOR_VIEWBOX.width} ${ANCHOR_VIEWBOX.height}`}
      className={className}
      aria-hidden
      fill={color}
    >
